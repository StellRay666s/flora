  ...
  return (
    <div className={style.advantaWrapper}>
      <div className={style.truck}>
        <TruckIcon fill="black" width={45} height={45} />
        <div>
      ...
      <div className={style.truck}>
        <BoqueteIcon fill="black" width={45} height={45} />
        <div>
      ...
      <div className={style.truck}>
        <CreditCartIcon fill="black" width={45} height={45} />
        <div>
      ...
      <div className={style.truck}>
        <GiftIcon fill="black" width={45} height={45} />
        <div>
          <h4>Подарок</h4>
